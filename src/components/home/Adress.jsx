...
const Adress = () => {
  return (
    <div className="mt-10 pb-10">
      ...
      <motion.div variants={fadeIn('down', 0.2)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className="mx-[20px] md:mx-[120px] md:mt-10">
        <div className="px-5 grid grid-cols-1 sm:grid-cols-2 mds:grid-cols-3 gap-[80px]">
          <div className="border-2 rounded-[30px] flex flex-col items-center p-5">
            <Link to="/gioi-thieu-chi-nhanh">
