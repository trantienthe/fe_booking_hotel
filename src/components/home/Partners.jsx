...
const Partners = () => {
  return (
    <div className="bg-bg-home-1 px-4 md:px-[100px] pb-20 pt-5">
      <motion.div variants={fadeIn('down', 0.2)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className="md:flex md:px-[50px] mt-5">
      ...
      <motion.div
        ...
        className="px-5 pt-5 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-5"
      >
